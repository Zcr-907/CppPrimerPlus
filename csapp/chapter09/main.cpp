 ...
 */
 /**
  * 64位操作系统中
  * 虚拟地址空间: 48位虚拟地址空间(12位VPO,36位VPN)
  * 物理地址空间: 52位物理地址空间(12位PPO,40位PPN)
  * 扩充: JVM的ZGC所使用到的染色指针就使用到了内存地址的信息位
  * 资料: https://tech.meituan.com/2020/08/06/new-zgc-practice-in-meituan.html
  *
  */
